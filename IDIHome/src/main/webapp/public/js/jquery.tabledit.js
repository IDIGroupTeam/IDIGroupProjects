                ...
                identifier: function() {
                	for (var i = 0; i < settings.columns.identifier.length; i++) {
                        ...
                        if (settings.hideIdentifier) {
                            $table.find('th:nth-child(' + parseInt(settings.columns.identifier[i][0]) + 1 + '), tbody td:nth-child(' + parseInt(settings.columns.identifier[i][0]) + 1 + ')').hide();
                        }
                        ...
                        $td.each(function() {
                            ...
                            var input = '<input class="tabledit-input tabledit-identifier" type="hidden" name="' + settings.columns.identifier[i][1] + '" value="' + $.trim($(this).text()) + '" disabled>';
