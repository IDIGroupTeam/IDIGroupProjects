...
public class BalanceSheetDAOImpl implements BalanceSheetDAO {
	...
	public void insertOrUpdateBSs(List<BalanceSheet> bss) {
		...
		String updateQry = "UPDATE BALANCE_ASSET SET END_VALUE=?, START_VALUE=?, CHANGED_RATIO=? WHERE ASSETS_CODE=? AND ASSETS_PERIOD=?";
		String insertQry = "INSERT INTO BALANCE_ASSET(ASSETS_NAME, RULE, ASSETS_CODE, NOTE, END_VALUE, START_VALUE, CHANGED_RATIO, ASSETS_PERIOD) VALUES(?, ?, ?, ?, ?, ?, ?, ?)";
	...
	public List<BalanceSheet> listBSsByAssetsCodeAndYear(String assetsCode, Date year) {
		...
		String query = "SELECT * FROM BALANCE_ASSET WHERE ASSETS_CODE = ? AND YEAR(ASSETS_PERIOD)=?";

		Calendar cal = Calendar.getInstance();
		cal.setTime(year);

		logger.info("Get list of balance asset by asserts_code and year ...");
		logger.info(query);
	...
	public List<BalanceSheet> listBSsByDate(Date date) {
		...
		String query = "SELECT * FROM BALANCE_ASSET WHERE YEAR(ASSETS_PERIOD)=?";

		Calendar cal = Calendar.getInstance();
		cal.setTime(date);

		logger.info("Get list of balance asset by year ...");
		logger.info(query);
	...
	public List<String> listBSAssetsCodes() {
		String query = "SELECT DISTINCT ASSETS_CODE FROM BALANCE_ASSET ORDER BY ASSETS_CODE";

		logger.info("Get list of ASSETS_CODE from balance asset table ...");
		logger.info(query);
	...
	public List<Date> listBSAssetsPeriods() {
		String query = "SELECT DISTINCT ASSETS_PERIOD FROM BALANCE_ASSET ORDER BY ASSETS_PERIOD";

		logger.info("Get list of ASSETS_PERIOD from balance asset table ...");
		logger.info(query);
