...
public class FinancialLeverageChartProcessor implements ChartPostProcessor, Serializable {
	private static final Logger logger = Logger.getLogger(FinancialLeverageChartProcessor.class);
