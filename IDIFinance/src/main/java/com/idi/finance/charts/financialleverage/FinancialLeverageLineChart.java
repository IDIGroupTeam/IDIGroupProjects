...
public class FinancialLeverageLineChart implements DatasetProducer, XYToolTipGenerator {
	private static final Logger logger = Logger.getLogger(FinancialLeverageLineChart.class);
	private HashMap<Date, FinancialLeverage> financialLeverages;
	private double threshold = 1.0;

	public FinancialLeverageLineChart(HashMap<Date, FinancialLeverage> financialLeverages, double threshold) {
	...
	public String getProducerId() {
		return "FinancialLeverageLineChart";
	}
