...
public class DebtRatioChartProcessor implements ChartPostProcessor, Serializable {
	private static final Logger logger = Logger.getLogger(DebtRatioChartProcessor.class);
