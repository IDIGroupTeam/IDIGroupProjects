...
<script type="text/javascript">
	...
	$(function() {
		...
		$("#mainFinanceForm").attr("action", "${url}/bctc/cdkt/capnhat/luu");
		$("#mainFinanceForm").attr("method", "POST");
	});
</script>

<h4>Sinh bảng cân đối kế toán</h4>
<hr />
...
<div class="row">
	...
	<div class="col-sm-6">
		<b>Chú ý:</b><i>Để đảm bảo tính cân đối, trước khi sinh bảng cân
			đối kế toán, cần chạy các <a href="${url}/chungtu/ketchuyen/danhsach"
...
<hr />
<div>
	<a href="${url}/bctc/cdkt/danhsach" class="btn btn-info btn-sm">
		Hủy </a>
