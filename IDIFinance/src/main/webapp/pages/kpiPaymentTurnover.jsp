...
<div class="text-center">
	<cewolf:overlaidchart id="receivableTurnoversChart"
		title="Vòng quay khoản phải trả" yaxislabel="Giá trị"
	...
	<cewolf:img chartid="receivableTurnoversChart" height="400" width="820"
		renderer="/cewolf">
