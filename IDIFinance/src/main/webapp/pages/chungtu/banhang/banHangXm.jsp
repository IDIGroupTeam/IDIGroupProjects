			...
			<tbody>
				<c:forEach items="${chungTu.hangHoaDs}" var="hangHoa"
					...
					<tr id="${status.index}">
						...
						<td>${hangHoa.tkChiPhi.loaiTaiKhoan.maTk}</td>
					</tr>
				</c:forEach>
			</tbody>
		</table>
...
<div class="row form-group">
	<div class="col-sm-12">
		<a href="${url}/chungtu/banhang/danhsach" class="btn btn-info btn-sm">Danh
			sách chứng từ bán hàng</a> <a
			href="${url}/chungtu/banhang/pdf/${chungTu.maCt}"
			class="btn btn-info btn-sm"> Xuất Pdf </a> <a
			href="${url}/chungtu/banhang/pdf/${chungTu.maCt}"
			class="btn btn-info btn-sm"> Phiếu xuất kho </a> <a id="xoaNut"
			href="${url}/chungtu/banhang/xoa/${chungTu.maCt}"
			class="btn btn-info btn-sm">Xóa</a> <a
			href="${url}/chungtu/banhang/sua/${chungTu.maCt}"
			class="btn btn-info btn-sm">Sửa</a> <a
			href="${url}/chungtu/banhang/taomoi" class="btn btn-info btn-sm">Tạo
			mới</a>
	</div>
</div>