...
<h4>TẠO MỚI CHỨNG TỪ MUA HÀNG</h4>
<hr />
...
<%-- <div class="row form-group">
	...
	<label class="control-label col-sm-2" for="lo.tenLo">Lô</label>
	<div class="col-sm-4">
		<form:input path="lo.tenLo" placeholder="Lô" cssClass="form-control" />
		<br />
		<form:errors path="lo.tenLo" cssClass="error" />
	</div>
</div> --%>
	...
	<div class="col-sm-3 form-group">
		...
		<div class="col-sm-6">
			<form:select path="tkThue.loaiTaiKhoan.maTk" cssClass="form-control">
				...
				<form:option value="133" label="133"></form:option>
				<form:option value="1331" label="1331"></form:option>
				<form:option value="1332" label="1332"></form:option>
			</form:select>
		</div>
	</div>
