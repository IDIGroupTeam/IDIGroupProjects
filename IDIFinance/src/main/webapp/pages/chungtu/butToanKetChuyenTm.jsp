...
<script type="text/javascript">
	...
	$(function() {
		...
		$("#mainFinanceForm").attr("action", "${url}/luutaomoibtkc");
...
<h4>BÚT TOÁN KẾT CHUYỂN</h4>
<hr />
<form:hidden path="loaiCt" />
<form:hidden path="ngayLap" />
<form:hidden path="ngayHt" />
<form:hidden path="doiTuong.loaiDt" />
<form:hidden path="loaiTien.maLt" />
<form:hidden path="loaiTien.banRa" />
<div class="row form-group">
	<label class="control-label col-sm-2" for="soCt">Số bút toán dự
		kiến:</label>
	<div class="col-sm-4">
	...
	<label class="control-label col-sm-2" for=ngayHt>Ngày bút toán:</label>
	<div class="col-sm-4">
...
<div class="row form-group">
	<label class="control-label col-sm-2" for="doiTuong.tenDt">Người
		bút toán:(*)</label>
	<div class="col-sm-4">
	...
	<label class="control-label col-sm-2" for="doiTuong.diaChi">Địa
		chỉ:</label>
	<div class="col-sm-4">
		<form:input path="doiTuong.diaChi" placeholder="Địa chỉ"
			cssClass="form-control" />
	</div>
</div>
...
<div class="table-responsive row form-group">
	<label class="control-label col-sm-2">Bút toán</label> <i
		class="pull-right"> Mặc định là tiền Việt Nam Đồng (VND)</i>
