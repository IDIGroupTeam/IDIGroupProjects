...
CREATE TABLE `idigroup`.KHACH_HANG ( `MA_KH` INT NOT NULL AUTO_INCREMENT , `KH_KH` VARCHAR(255) NOT NULL, `TEN_KH` VARCHAR(255) NOT NULL , `MA_THUE` VARCHAR(100) NOT NULL , `DIA_CHI` VARCHAR(255) NOT NULL , `EMAIL` VARCHAR(100) NOT NULL , `SDT` VARCHAR(20) NOT NULL , `WEBSITE` VARCHAR(255) NOT NULL, PRIMARY KEY (`MA_KH`) ) ENGINE = InnoDB CHARACTER SET utf8 COLLATE utf8_general_ci;
INSERT INTO `KHACH_HANG` (`MA_KH`, `TEN_KH`, `MA_THUE`, `DIA_CHI`, `EMAIL`, `SDT`, `WEBSITE`) VALUES
(1, 'Khách vãng lai', '', '', '', '', '');

CREATE TABLE `idigroup`.NHA_CUNG_CAP ( `MA_NCC` INT NOT NULL AUTO_INCREMENT , `KH_NCC` VARCHAR(255) NOT NULL, `TEN_NCC` VARCHAR(255) NOT NULL , `MA_THUE` VARCHAR(100) NOT NULL , `DIA_CHI` VARCHAR(255) NOT NULL , `EMAIL` VARCHAR(100) NOT NULL , `SDT` VARCHAR(20) NOT NULL , `WEBSITE` VARCHAR(255) NOT NULL, PRIMARY KEY (`MA_NCC`) ) ENGINE = InnoDB CHARACTER SET utf8 COLLATE utf8_general_ci;
...
CREATE TABLE `idigroup`.`CDKT_TAIKHOAN` ( `ASSET_CODE` VARCHAR(10) NOT NULL , `MA_TK` VARCHAR(10) NOT NULL, `MA_TK_GOC` VARCHAR(10) NOT NULL, `SO_DU` TINYINT(1) NOT NULL, PRIMARY KEY (`ASSET_CODE`, `MA_TK`) ) ENGINE = InnoDB;
-- Theo thông tư 200 
...
CREATE TABLE `idigroup`.`KY_KE_TOAN_SO_DU` (`MA_KKT` INT NOT NULL , `MA_TK` VARCHAR(10) NOT NULL , `MA_DT` INT NOT NULL, `LOAI_DT` TINYINT(1) NOT NULL, `MA_HH` INT NOT NULL, `MA_KHO` INT NOT NULL, `NO_DAU_KY` DOUBLE NOT NULL, `CO_DAU_KY` DOUBLE NOT NULL, `NO_CUOI_KY` DOUBLE NOT NULL, `CO_CUOI_KY` DOUBLE NOT NULL, `MA_DV` INT NOT NULL, PRIMARY KEY (`MA_KKT`,`MA_TK`,`MA_DT`,`LOAI_DT`,`MA_HH`,`MA_KHO`)) ENGINE = InnoDB;
