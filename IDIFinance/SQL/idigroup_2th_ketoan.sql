...
CREATE TABLE `idigroup`.`TAI_KHOAN_DANH_MUC` ( `MA_TK` VARCHAR(10) NOT NULL , `TEN_TK` VARCHAR(255) NOT NULL , `MA_TK_CHA` VARCHAR(10) NULL , `SO_DU` TINYINT(1) NOT NULL DEFAULT -1, PRIMARY KEY (`MA_TK`)) ENGINE = InnoDB CHARACTER SET utf8 COLLATE utf8_general_ci;
