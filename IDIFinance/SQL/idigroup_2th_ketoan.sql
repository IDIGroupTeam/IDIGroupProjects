...
CREATE TABLE `idigroup`.`TAI_KHOAN_DANH_MUC` ( `MA_TK` VARCHAR(10) NOT NULL , `TEN_TK` VARCHAR(255) NOT NULL , `MA_TK_CHA` VARCHAR(10) NULL , `SO_DU` TINYINT(1) NOT NULL DEFAULT -1, `MA_TK_NH` INT NULL, PRIMARY KEY (`MA_TK`)) ENGINE = InnoDB CHARACTER SET utf8 COLLATE utf8_general_ci;
...
CREATE TABLE `idigroup`.`CHUNG_TU` (`MA_CT` int(11) NOT NULL AUTO_INCREMENT, `SO_CT` int(11) DEFAULT NULL, `LOAI_CT` varchar(100) DEFAULT NULL, `NGAY_LAP` date NOT NULL, `NGAY_HT` date NOT NULL, `LY_DO` varchar(255) NOT NULL, `LOAI_TIEN` varchar(10) NOT NULL DEFAULT 'VND', `TY_GIA` double NOT NULL DEFAULT '1', `KEM_THEO` int(11) DEFAULT NULL, `MA_DT` int(11) NULL, `LOAI_DT` TINYINT(1) NULL, `NGUOI_NOP` varchar(255) NULL, `MA_KHO` INT NULL, `NGAY_TAO` DATE NULL, `NGAY_SUA` DATE NULL, PRIMARY KEY (`MA_CT`)) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `idigroup`.`CHUNG_TU_HANG_HOA` ( `MA_CT` INT NOT NULL , `MA_HH` INT NULL ,  `MA_KHO` INT NULL, `SO_LUONG_CT` DOUBLE NULL, `SO_LUONG_TN` DOUBLE NULL, `GIA_MUA` DOUBLE NULL, `GIA_NHAP_KHO` DOUBLE NULL, `GIA_BAN` DOUBLE NULL, PRIMARY KEY( `MA_CT`, `MA_HH`)) ENGINE = InnoDB;
CREATE TABLE `idigroup`.`CHUNG_TU_NVKT` ( `MA_CT` INT NOT NULL , `MA_HH` INT NULL , `MA_NVKT` INT NOT NULL, `LOAI_TK` TINYINT NULL ) ENGINE = InnoDB;
