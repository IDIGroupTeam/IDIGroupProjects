...
CREATE TABLE `idigroup`.`KY_KE_TOAN_SO_DU` (`MA_KKT` INT NOT NULL , `MA_TK` VARCHAR(10) NOT NULL , `MA_DT` INT NULL, `LOAI_DT` TINYINT(1) NULL, `NO_DAU_KY` DOUBLE NULL, `CO_DAU_KY` DOUBLE NULL, `NO_CUOI_KY` DOUBLE NULL, `CO_CUOI_KY` DOUBLE NULL, PRIMARY KEY (`MA_KKT`,`MA_TK`,`MA_DT`,`LOAI_DT`)) ENGINE = InnoDB;
