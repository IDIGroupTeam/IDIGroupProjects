...
CREATE TABLE `idigroup`.`CHUNG_TU_TAI_KHOAN` ( `MA_CT` INT NOT NULL , `MA_TK` VARCHAR(10) NOT NULL ,  `SO_TIEN` double NOT NULL, `SO_DU` TINYINT NOT NULL DEFAULT '1', PRIMARY KEY (`MA_CT`, `MA_TK`) ) ENGINE = InnoDB CHARACTER SET utf8 COLLATE utf8_general_ci;
CREATE TABLE `idigroup`.`CHUNG_TU` (`MA_CT` int(11) NOT NULL AUTO_INCREMENT, `SO_CT` int(11) DEFAULT NULL, `LOAI_CT` varchar(100) DEFAULT NULL, `NGAY_LAP` date NOT NULL,  `LY_DO` varchar(255) NOT NULL, `SO_TIEN` double NOT NULL, `LOAI_TIEN` varchar(10) NOT NULL DEFAULT 'VND', `TY_GIA` double NOT NULL DEFAULT '1', `KEM_THEO` int(11) DEFAULT NULL, `MA_DT` int(11) NOT NULL, `LOAI_DT` TINYINT NOT NULL, `NGUOI_NOP` varchar(255) NOT NULL, PRIMARY KEY (`MA_CT`)) ENGINE=InnoDB DEFAULT CHARSET=utf8;
