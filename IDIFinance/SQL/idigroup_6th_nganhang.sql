...
CREATE TABLE `idigroup`.`NGAN_HANG` ( `MA_NH` INT NOT NULL AUTO_INCREMENT , `TEN_VT` VARCHAR(50) NOT NULL , `TEN_DD` VARCHAR(255) NOT NULL , `TEN_TA` VARCHAR(255) NULL , `DIA_CHI_HSC` VARCHAR(255) NULL , `BIEU_TUONG` VARCHAR(255) NULL , `MO_TA` VARCHAR(255) NULL , PRIMARY KEY (`MA_NH`)) ENGINE = InnoDB;
