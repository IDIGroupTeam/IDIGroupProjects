				...
				while (cellIter.hasNext()) {
					...
					if (columnStrIndex.equalsIgnoreCase("C")) {
						...
						if (DateUtil.isCellDateFormatted(cell)) {
							...
							logger.info("Ngay: " + date.getDate() + "/" + (date.getMonth() + 1) + "/"
									+ (1900 + date.getYear()));
							timekeeping.setDate(
									date.getDate() + "/" + (date.getMonth() + 1) + "/" + (1900 + date.getYear()));
						}
					...
					if (columnStrIndex.equalsIgnoreCase("L")) {
						...
						case STRING:
							...
							int lateMValue = 0;
							if(Integer.parseInt(h) > Integer.parseInt(hr.getProperty("TIME_CHECK_IN_MORNING")) && Integer.parseInt(h) < Integer.parseInt(hr.getProperty("TIME_CHECK_OUT_MORNING"))) {
								lateMValue = Integer.parseInt(h) - Integer.parseInt(hr.getProperty("TIME_CHECK_IN_MORNING"));
								System.err.println("Muon sang: " + lateMValue + ":" + s);	
								timekeeping.setComeLateM("0" + lateMValue + ":" + s);
							}else if(Integer.parseInt(h) == Integer.parseInt(hr.getProperty("TIME_CHECK_IN_MORNING")) && Integer.parseInt(s) > 0){
							...
							if(Integer.parseInt(h) > Integer.parseInt(hr.getProperty("TIME_CHECK_IN_AFTERNOON"))) {
								lateAValue = Integer.parseInt(h) - Integer.parseInt(hr.getProperty("TIME_CHECK_IN_AFTERNOON"));
								System.err.println("Muon chieu: " + lateAValue + ":" + s);	
								timekeeping.setComeLateA("0" + lateAValue + ":" + s);
							}else if(Integer.parseInt(h) == Integer.parseInt(hr.getProperty("TIME_CHECK_IN_AFTERNOON")) && Integer.parseInt(s) > 0){
					...
					if (columnStrIndex.equalsIgnoreCase("M")) {
						...
						case STRING:
							...
							if(Integer.parseInt(h) < Integer.parseInt(hr.getProperty("TIME_CHECK_OUT_MORNING"))) {
								soonMValue = Integer.parseInt(hr.getProperty("TIME_CHECK_OUT_MORNING")) - (Integer.parseInt(h) + 1);
							...
							int soonAValue = 0;
							if(Integer.parseInt(h) >= Integer.parseInt(hr.getProperty("TIME_CHECK_IN_AFTERNOON")) && Integer.parseInt(h) < Integer.parseInt(hr.getProperty("TIME_CHECK_OUT_AFTERNOON"))) {
								soonAValue = Integer.parseInt(hr.getProperty("TIME_CHECK_OUT_AFTERNOON")) - (Integer.parseInt(h) + 1 );
								System.err.println("Ve som chieu: " + soonAValue + ":" + (60 - Integer.parseInt(s)));	
								String hour = "0";
								int min = 60 - Integer.parseInt(s);
