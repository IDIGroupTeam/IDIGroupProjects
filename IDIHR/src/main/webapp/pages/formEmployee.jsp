			...
			<table class="table">
				<tbody>
					...
					<tr>
						...
						<td>Quốc tịch: <form:input path="nation" size="18"
								maxlength="32" /></td>
					</tr>
					<tr>
						<td bgcolor="#E6E6E6">CMND/CCCD/passportNo:</td>
						<td><form:input path="personalId" size="12" maxlength="12"
								class="form-control animated" /></td>
						...
						<td>Nơi cấp: &nbsp; <form:input path="issuePlace" size="32"
								maxlength="32" /></td>

					</tr>
					<tr>
						<td bgcolor="#E6E6E6">Đ/c hiện tại:</td>
						<td><form:input path="currentAdress" maxlength="255"
								class="form-control animated" /></td>
					...
					<tr>
						...
						<td><form:input path="emerName" maxlength="32"
								class="form-control animated" /></td>
